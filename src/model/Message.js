...
export class Message extends Model {
    ...
    set id(valeu) { return this._data.id = value; }
    ...
    set preview(valeu) { return this._data.preview = value; }

    get info() { return this._data.info; }
    set info(valeu) { return this._data.info = value; }

    get fileType() { return this._data.fileType; }
    set fileType(valeu) { return this._data.fileType = value; }

    get filename() { return this._data.filename; }
    set filename(valeu) { return this._data.filename = value; }

    get size() { return this._data.size; }
    set size(valeu) { return this._data.size = value; }

    get from() { return this._data.from; }
    set from(valeu) { return this._data.from = value; }
